            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-title text-center">
                        <h3 class="mb-5" data-id="<?php echo e($service->id); ?>"; id="service"><?php echo e($service->name); ?></h3>
                    </div>
                    <div class="card-title text-left mb-4">
                        <label class="fs-4" for="start">Дата:</label>
                        <input name="date" type="date" id="date" name="trip-start">
                    </div>

                    <div class="card-title text-left mb-4">
                        <label class="fs-4" for="start">Час:</label>
                        <input name="selectedHour" id="selectedHour" type="text" required>
                    ...
                    <div class="card-title text-left mb-4">
                        <button name="submit" type="submit" class="btn btn-success w-100 fs-5">
                        Запази
                        </button>
                    </div>
...
<script src="<?php echo e(base_url()); ?>/js/menuZapaziChas.js"></script>

<?php $__env->stopSection(); ?>


<?php echo $__env->make('layout.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp 7.4\htdocs\views/appointmentMenu.blade.php ENDPATH**/ ?>